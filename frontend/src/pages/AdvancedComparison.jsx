          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                <InputLabel id="primary-target-label">Primary Target *</InputLabel>
                <Select
              labelId="primary-target-label"
              id="primary-target-select"
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                <InputLabel id="compare-with-label">Compare With (Optional)</InputLabel>
                <Select
      ...
      >
        ...
        >
          ...
          {/* Street Filter */}
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth size="small">
                <InputLabel id="street-filter-label">Street</InputLabel>
                <Select
              labelId="street-filter-label"
              id="street-filter-select"
          ...
          {/* Pot Type */}
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth size="small">
                <InputLabel id="pottype-filter-label">Pot Type</InputLabel>
                <Select
              labelId="pottype-filter-label"
              id="pottype-filter-select"
              ...
              >
                <Grid container spacing={2} sx={{ mt: 2 }}>
                  ...
                  <Grid item xs={12} md={8}>
                    ...
                    <Box display="flex" gap={2} alignItems="center">
                      <TextField
                    id="min-preflop-score"
                    name="min_preflop_score"
                    type="number"
                    placeholder="Min"
                    ...
                    onChange={(e) => handleFilterChange('min_preflop_score', e.target.value)}
                      ...
                      <Typography color="text.secondary">-</Typography>
                      <TextField
                    id="max-preflop-score"
                    name="max_preflop_score"
                    type="number"
                    placeholder="Max"
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    <FormControl fullWidth size="small">
                      <InputLabel id="sizecat-filter-label">Size Category</InputLabel>
                      <Select
                  labelId="sizecat-filter-label"
                  id="sizecat-filter-select"

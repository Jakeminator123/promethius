...
def execute_query(query: str, params: tuple[object, ...] = (), db_name: str = 'heavy_analysis.db') -> list[dict[str, object]]:
    """
    ...
    try:
        with get_connection(db_name) as conn:
            ...
            results: list[dict[str, object]] = [cast(dict[str, object], dict(r)) for r in result_rows]
            return results

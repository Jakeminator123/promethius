...
#!/usr/bin/env python3
"""
player_stats.py – detaljerad spelar-statistik från heavy_analysis.db
===================================================================

Funktioner
----------
* Beräknar VPIP %, PFR %, genomsnittligt `action_score` och `decision_difficulty`
  per spelare.
* Segmentering per street (preflop, flop, turn, river eller alla).
* Filtrering på minsta antal händer, valfria spelare och topp-N.
* Valfri sortering och export till CSV.

Se README-exemplen för snabbstart.
"""
